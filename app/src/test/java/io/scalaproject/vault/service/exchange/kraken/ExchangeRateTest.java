...
public class ExchangeRateTest {
    ...
    public void queryExchangeRate_shouldBeGetMethod()
        ...
        exchangeApi.queryExchangeRate("XLA", "USD", mockExchangeCallback);
    ...
    public void queryExchangeRate_shouldHavePairInUrl()
        ...
        RecordedRequest request = mockWebServer.takeRequest();
        assertEquals("/?pair=XLAUSD", request.getPath());
    }
    ...
    public void queryExchangeRate_wasNotSuccessfulShouldCallOnError()
        ...
        exchangeApi.queryExchangeRate("XLA", "USD", new ExchangeCallback() {
            @Override
            public void onSuccess(final ExchangeRate exchangeRate) {
                waiter.fail();
                waiter.resume();
    ...
    public void queryExchangeRate_unknownAssetShouldCallOnError()
        ...
        exchangeApi.queryExchangeRate("XLA", "ABC", new ExchangeCallback() {
            @Override
            public void onSuccess(final ExchangeRate exchangeRate) {
                waiter.fail();
                waiter.resume();
