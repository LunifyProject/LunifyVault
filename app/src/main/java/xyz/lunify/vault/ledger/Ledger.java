...
import xyz.btchip.BTChipException;
import xyz.btchip.comm.BTChipTransport;
import xyz.btchip.comm.android.BTChipTransportAndroidHID;
...
public class Ledger {
    ...
    static public boolean check() {
        ...
        byte[] lunifyVersion = WalletManager.lunifyVersion().getBytes(StandardCharsets.US_ASCII);

        try {
            byte[] resp = Instance.exchangeApduNoOpt(Instruction.INS_RESET, lunifyVersion, OK);
    ...
    // without messing around with lunify core code
