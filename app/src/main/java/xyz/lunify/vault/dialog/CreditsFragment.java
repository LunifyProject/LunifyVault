...
public class CreditsFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView tvLunifyURL = view.findViewById(R.id.LunifyURL);
        tvLunifyURL.setText(Html.fromHtml(getString(R.string.LunifyLink)));
        tvLunifyURL.setMovementMethod(LinkMovementMethod.getInstance());
