...
import xyz.theromus.sha.Keccak;
import xyz.theromus.sha.Parameters;
...
public class Lunify {
    ...
    private byte[] mkey;
    private byte[] mchain;
    private byte[] lunify_ki;
    private byte[] lunify_ci;
    ...
    private void makeKeys() {
        ...
        final byte[] b = keccak.getHash(lunify_ki, Parameters.KECCAK_256);
        reverse(b);
