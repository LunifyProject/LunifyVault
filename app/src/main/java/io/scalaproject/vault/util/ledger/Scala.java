 ...
 * https://github.com/LedgerHQ/ledger-app-scala/blob/master/tools/python/src/ledger/scala/seedconv.py
 *
...
public class Scala {
    ...
    private byte[] mkey;
    private byte[] mchain;
    private byte[] scala_ki;
    private byte[] scala_ci;
    ...
    private void makeKeys() {
        ...
        final byte[] b = keccak.getHash(scala_ki, Parameters.KECCAK_256);
        reverse(b);
