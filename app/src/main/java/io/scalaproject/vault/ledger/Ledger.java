...
public class Ledger {
    ...
    static public boolean check() {
        ...
        byte[] scalaVersion = WalletManager.scalaVersion().getBytes(StandardCharsets.US_ASCII);

        try {
            byte[] resp = Instance.exchangeApduNoOpt(Instruction.INS_RESET, scalaVersion, OK);
    ...
    // without messing around with scala core code
