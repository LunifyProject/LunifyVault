...
class CreateOrderImpl implements CreateOrder {
    ...
    public static void call(@NonNull final XlaToApiCall api, final double amount, @NonNull final String address,
    ...
    public static void call(@NonNull final XlaToApiCall api, @NonNull final String url,
                            @NonNull final XlaToCallback<CreateOrder> callback) {
        try {
