...
public class ExchangeApiImpl implements ExchangeApi {
    ...
    // Lunify Network API for prices no need any extra parameter in the url allways return the same value
    public ExchangeApiImpl(@NonNull final OkHttpClient okHttpClient) {
        this(okHttpClient, Objects.requireNonNull(HttpUrl.parse("https://prices.lunify.xyz/")));
    }
